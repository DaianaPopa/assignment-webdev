...
?>
    <div class="mainContainer">
              ...
              <section class="twoColumn">
                ...
                <div class="sideBar">
                <h3> Computing Course</h3>
                <p> The College offers a range of courses to suit applicants with varying backgrounds 
and educational abilities. At undergraduate level, there are single BSc Honours Degree courses in Computing, Computer Networks, Software Engineering and Cyber Security with Forensics amongst others. </p>
                ...
                <h3><a href= "courseDetails.php">Course Details</a></h3>
                <div> <img src="website-images/Computing-Lab-2.jpg" alt="Lab"style= "width:200px; height:100px; "/> </div>
